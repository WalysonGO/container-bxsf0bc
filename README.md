...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bxsf0bc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bxsf0bc.containers.anotherwebservice.com/
...
```
git clone git@github.com:WalysonGO/container-bxsf0bc.git
cd container-bxsf0bc
```
...
```
docker attach container-bxsf0bc
```
